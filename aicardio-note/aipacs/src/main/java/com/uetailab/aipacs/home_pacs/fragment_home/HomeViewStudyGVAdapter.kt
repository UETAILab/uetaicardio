...
class HomeViewStudyGVAdapter(val applicationContext: Context, val listener: OnStudyPreviewClicked, val homeViewMV: HomeViewVM) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        convertView?.let {
            ...
            ViewHolder(view).bind(getItem(position), getHasAnnotation(position))
            return view
        }
    }
    ...
    fun getHasAnnotation(position: Int): Boolean {
        ...
        return homeViewMV.getHasAnnotation(relativePath)
    }
...
//
            ...
            val dataView = homeViewMV.getDicomViewAndNumberOfFrame(shortName)
