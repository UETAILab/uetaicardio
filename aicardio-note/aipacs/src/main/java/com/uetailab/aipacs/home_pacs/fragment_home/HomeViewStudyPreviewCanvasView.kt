...
class HomeViewStudyPreviewCanvasView : androidx.appcompat.widget.AppCompatImageView,
    OnScaleListener
{
    ...
    @Suppress("unused")
    private val log = Logger.getLogger(HomeViewStudyPreviewCanvasView::class.java.name)
