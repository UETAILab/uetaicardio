 ...
 */
class InterpretationViewRadioGridGroup : GridLayout {
    ...
    override fun onInitializeAccessibilityEvent(event: AccessibilityEvent) {
        ...
        event.className = InterpretationViewRadioGridGroup::class.java.name
    }

    override fun onInitializeAccessibilityNodeInfo(info: AccessibilityNodeInfo) {
        super.onInitializeAccessibilityNodeInfo(info)
        info.className = InterpretationViewRadioGridGroup::class.java.name
    }

    interface OnCheckedChangeListener {
        fun onCheckedChanged(groupInterpretationView: InterpretationViewRadioGridGroup?, checkedId: Int)
    }
    ...
    private inner class PassThroughHierarchyChangeListener : OnHierarchyChangeListener {
        ...
        override fun onChildViewAdded(parent: View, child: View) {
            if (parent === this@InterpretationViewRadioGridGroup && child is AppCompatRadioButton) {
                var id = child.getId()
