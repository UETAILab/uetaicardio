...
//                 Get the size in pixels
    ...
    suspend fun getTagsDicomValue(dataSet: DataSet): JSONObject = withContext(Dispatchers.IO){
        ...
        try {
            ...
            Log.w(com.ailab.aicardio.TAG, "getTagsDicomValue ${e}")
    ...
    suspend fun getTagDicom(
        loadedDataSet: DataSet
    ) : LCE<JSONObject>  = withContext(Dispatchers.IO){
        val details = JSONObject()
