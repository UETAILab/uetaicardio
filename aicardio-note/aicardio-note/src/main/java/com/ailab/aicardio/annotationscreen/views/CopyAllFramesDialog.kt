...
import kotlinx.android.synthetic.main.dialog_copy_all_frames.*


class CopyAllFramesDialog(
    val activity: Activity,
    val listener: OnSaveCopyAllFramesListener
    ...
    interface OnSaveCopyAllFramesListener {
        fun onSaveCopyAllFrames()
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val layout: View = inflater.inflate(R.layout.dialog_copy_all_frames, null)
