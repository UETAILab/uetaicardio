...
import com.ailab.aicardio.api.AnnotationApi
...
//    suspend fun getDicomAnnotation() : LCE<DicomAnnotation> {
//        val annotationApiResult = try {
//            AnnotationApi.create().getDicomAnnotation()
//        } catch (e: Exception) {
//            return LCE.Error(e)
//        }
//
//        return if (annotationApiResult.status) {
//            LCE.Result(data = DicomAnnotation(), error = false, message = "no error")
//        } else {
//            LCE.Error(message = "status not ok")
//        }
//    }
