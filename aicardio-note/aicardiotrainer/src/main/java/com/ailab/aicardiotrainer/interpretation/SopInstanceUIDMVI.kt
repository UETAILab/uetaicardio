...
//                interpretationActivity.inter_iv_draw_canvas.setCustomImageBitmap(viewState.sopInstanceUIDBitmaps.get(0))
            ...
            InterpretationViewStatus.OnLoadingMP4SopInstanceUID -> {
                interpretationActivity.inter_iv_draw_canvas.infoText = LOAD_NEW_SOPINSTANCEUID
                interpretationActivity.inter_iv_draw_canvas.setCustomImageBitmap(InterpretationActivity.bitmapHeart)
